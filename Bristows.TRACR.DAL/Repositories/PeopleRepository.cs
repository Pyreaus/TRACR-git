...
{
    public sealed class PeopleRepository : RepositoryBase<PeopleFinderUser, TRACRContext, PeopleRepository>, IPeopleRepository  //IEmployeeRepo implemented in RepoBase
    {
