...
public sealed partial class UserController : ControllerBase
{
    ...
    public async Task<ActionResult<TraineeViewModel>?> SetPair([FromRoute] [ValidPfid] int pfid, [FromBody] AddModifyTraineeReq request)
    {
        Trainee? currentTrainee = await _userService.GetTraineeByPfidAsync(pfid);
        if ((currentTrainee is null)||(request is null)||(await _userService.GetPFUserAsync(pfid) is null)) return StatusCode(400);
    ...
    public async Task<ActionResult<TraineeViewModel?>> AssignTrainees([FromRoute] [ValidPfid] int pfid, [FromBody] AddModifyTraineeReq request)
    {
        if ((await _userService.GetPFUserAsync(pfid) is null)||(request is null)) return StatusCode(400);
    ...
    public async Task<ActionResult<TraineeViewModel?>> EditTrainee([FromRoute] [ValidPfid] int pfid, [FromBody] AddModifyTraineeReq request)
    {
    ...
    public async Task<ActionResult<UserViewModel?>> GetUserType([FromServices] IWebHostEnvironment host)
    {
